-- circadia-plum -- a mini.base16 port of the Circadia palette spec:
-- https://github.com/tanmaymanojgandhi/circadia (spec/palette.json, v2.0.0)
-- 'background' picks the variant: dark_plum when dark, light_parchment when
...
local palettes = {
   dark = {
      base16 = {
         base00 = '#140e12', -- bg_canvas
         base01 = '#1b1419', -- bg_surface
         base02 = '#261e23', -- bg_element
         base03 = '#a5999f', -- comments
         base04 = '#b4a3af', -- text_muted
         base05 = '#d8c8d2', -- text_primary
         base06 = '#d8c8d2', -- text_primary
         base07 = '#d8c8d2', -- text_primary
         base08 = '#daa97a', -- "red" (circadia has none; ANSI color1 is the amber type tone)
         base09 = '#d49969', -- numbers
         base0A = '#daa97a', -- types
         base0B = '#96b77b', -- strings
         base0C = '#d38da4', -- properties
         base0D = '#b695cf', -- functions
         base0E = '#75acd2', -- keywords
         base0F = '#9a8b96', -- text_faint (delimiters)
      },
      border = '#3d3039',
      accent = '#cf8aa4',
      diff = { add = '#282722', change = '#23262f', text = '#313d4c', delete = '#322522' },
      term = {
         '#140e12', '#daa97a', '#96b77b', '#d49969', '#75acd2', '#b695cf', '#d49969', '#d8c8d2',
         '#9a8b96', '#da7ea0', '#96b77b', '#f5b8d0', '#75acd2', '#d38da4', '#75acd2', '#d8c8d2',
      },
   },
   light = {
      base16 = {
...
vim.g.colors_name = 'circadia-plum'

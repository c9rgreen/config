-- standard-dark -- a mini.base16 port of the arete.nvim theme:
...
require('mini.base16').setup({
   palette = {
      base00 = '#000000', -- bg
      base01 = '#363636', -- bg_dim
      base02 = '#20009d', -- selection
...
vim.g.colors_name = 'standard-dark'
...
hi('Float', { fg = '#7fffd4' })
hi('FloatBorder', { fg = '#606070' })
hi('FoldColumn', { fg = '#ffffff', bg = '#272727' })
hi('Folded', { fg = '#a6a6a6' })
...
hi('StatusLineNC', { fg = '#a6a6a6', bg = '#323232', underline = true })
hi('StorageClass', { fg = '#00ffff', bold = true })
hi('String', { fg = '#ffa07a' })
hi('Structure', { fg = '#00ffff', bold = true })
hi('TabLine', { bg = '#363636' })
hi('TabLineFill', { bg = '#363636' })
...
hi('VertSplit', { fg = '#606070' })
hi('Visual', { bg = '#20009d' })
hi('VisualNOS', { fg = '#ffffff', bg = '#00688b' })
hi('WarningMsg', { fg = '#fec43f', bold = true })
hi('WinSeparator', { fg = '#606070' })

-- Terminal palette from the official theme.
local term = {
   '#000000', '#ff6f60', '#44cc44', '#eedd82', '#87ceff', '#df8faf', '#00ffff', '#a6a6a6',
   '#606060', '#ff7f24', '#98fb98', '#fec43f', '#80aaff', '#ce82ff', '#7fffd4', '#ffffff',
}
